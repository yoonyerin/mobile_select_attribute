...
selected_1=["Narrow_Eyes", "Straight_Hair", "Pale_Skin", "Receding_Hairline", "Bald", "Oval_Face", 
...
selected_3=[ "Young", "Straight_Hair", "Receding_Hairline", "Chubby", "Big_Lips", ##"5_o_Clock_Shadow", "No_Beard", "Oval_Face", "Rosy_Cheeks", "Male",
            "Heavy_Makeup", "Wearing_Lipstick", "Mouth_Slightly_Open"]
selected_4=["Narrow_Eyes", "Straight_Hair", "Pale_Skin", "Receding_Hairline", "Oval_Face", "Goatee", "Big_Nose",
            "Attractive", "Arched_Eyebrows", "5_o_Clock_Shadow", "No_Beard", "Heavy_Makeup", "Wearing_Lipstick"]
selected_5=["Bald", "Pointy_Nose", "Young", "Straight_Hair", "Attractive", "Chubby", "Oval_Face", "Male", "Narrow_Eyes", "Rosy_Cheeks",
            "High_Cheekbones"]
selected_6=[ "Straight_Hair", "Big_Lips","Young",
